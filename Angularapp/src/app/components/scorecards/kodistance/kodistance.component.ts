...
@Component({
  selector: 'app-kodistance',
  templateUrl: './kodistance.component.html',
  styleUrls: ['./kodistance.component.scss']
})

export class KODistanceComponent implements OnInit {
  ...
  ExportToExcel(strNexPrev: string) {
    try {
      ...
      const fileName = `KODistance_${monthName}_${this.fastFrontendService.selectedYear}.xlsx`;
