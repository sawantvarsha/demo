...
@Component({
  selector: 'app-fx-dq',
  templateUrl: './fx-dq.component.html',
  styleUrls: ['./fx-dq.component.scss']
})
export class FxDqComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.mapleapi.maplegetbidask("EUR - USD","FXOption","FXOSEN");
    // this.mapleapi.bidAskFXD.subscribe(res => {
    //   if(res)
    //   {           
    //     console.log("Maple FXD bid ask = ",res);
    //   }
    // })
