...
@Component({
  selector: 'app-fx-aq',
  templateUrl: './fx-aq.component.html',
  styleUrls: ['./fx-aq.component.scss']
})
export class FxAqComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.mapleapi.maplegetccy("4","6","FXAQ","FXOSEN","","Y","","","","TOK");
    ...
    // this.mapleapi.maplegetbidask("EUR - USD","FXAQ","FXOSEN");
    // this.mapleapi.bidAskFXD.subscribe(res => {
    //   if(res)
    //   {           
    //     console.log("Maple FXD bid ask(FXAQ) = ",res);
    //   }
    // })
