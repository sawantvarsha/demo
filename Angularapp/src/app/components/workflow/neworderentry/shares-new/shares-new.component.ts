...
@Component({
  selector: 'app-shares-new',
  templateUrl: './shares-new.component.html',
  styleUrls: ['./shares-new.component.scss'],
})
export class SharesNewComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.workflowApi.getBusinessDate().then((date) => {
      ...
      if(this.actionName.toUpperCase() === 'SUBSCRIBE') {
