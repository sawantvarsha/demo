...
@Component({
  selector: 'app-ec-multi-earlyredemption',
  templateUrl: './ec-multi-earlyredemption.component.html',
  styleUrls: ['./ec-multi-earlyredemption.component.scss']
})
export class EcMultiEarlyredemptionComponent implements OnInit {
                  ...
                  if (params.RFQ_ID) {
                      ...
                      // Removed onbehalf dependency || PriyaL || 25Apr2022 || Assigned by Pranav D
                       ...
                       // changed by Suvarna P || 27Apr2022 || shares not loading in Autocallable product || assigned by Pranav D 
                         // this.shares = this.apifunctions.BBVALoadShares('EQ',"", index > -1 ? this.apifunctions.payOffList[index].displayName : "EQC_Europe");
                         this.shares = await this.apifunctions.BBVALoadShares('EQ',"", index > -1 ? this.apifunctions.payOffList[index].prevQuoteProductName : "EQC_Europe");
                       }
