...
@Component({
  selector: 'app-ec-submultirequest-er',
  templateUrl: './ec-submultirequest-er.component.html',
  styleUrls: ['./ec-submultirequest-er.component.scss']
})
export class EcSubmultirequestErComponent implements OnInit {
