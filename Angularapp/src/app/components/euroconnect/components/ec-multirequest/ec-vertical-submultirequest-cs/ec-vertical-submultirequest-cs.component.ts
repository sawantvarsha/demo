...
@Component({
  selector: 'app-ec-vertical-submultirequest-cs',
  templateUrl: './ec-vertical-submultirequest-cs.component.html',
  styleUrls: ['./ec-vertical-submultirequest-cs.component.scss']
})
export class EcVerticalSubmultirequestCsComponent implements OnInit {
