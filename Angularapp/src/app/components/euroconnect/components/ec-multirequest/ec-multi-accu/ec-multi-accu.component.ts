...
@Component({
  selector: 'app-ec-multi-accu',
  templateUrl: './ec-multi-accu.component.html',
  styleUrls: ['./ec-multi-accu.component.scss'],
})
export class EcMultiAccuComponent implements OnInit {
  @Output()
        ...
        if (params.RFQ_ID) {
          ...
          if (preQuoteData1.cloneData) {
            ...
            this.multiPhoenixArr.push({
              ...
              ShareBBGRIC1:
                cloneData.Underlying1 !== undefined
                  ? cloneData.Underlying1[0]
                  : '',
              ...
              //Added new parameter to pass exchange || PriyaL || 12Apr2022
              Exchange1:
                cloneData.Exchange1 !== undefined ? cloneData.Exchange1[0] : '',
              ...
              // Added by Amogh K | 5May2022 | ccy passed while cloning from homepage to multipricer
              Ccy: cloneData.CCY[0],
            });
          }
        }
