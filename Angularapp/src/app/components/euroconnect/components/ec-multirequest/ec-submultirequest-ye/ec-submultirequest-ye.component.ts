...
@Component({
  selector: 'app-ec-submultirequest-ye',
  templateUrl: './ec-submultirequest-ye.component.html',
  styleUrls: ['./ec-submultirequest-ye.component.scss']
})
export class EcSubmultirequestYeComponent implements OnInit {
  ...
  ngOnDestroy(): void {
    ...
    this.excelFlagSubscription?.unsubscribe(); // Bulk Pricer (YE) - Export to excel 
