...
import { ApifunctionService } from '../../../../services/ucp/apifunction.service';
import { DatePipe } from '@angular/common';
import {DateAdapter, MAT_DATE_FORMATS, MAT_DATE_LOCALE} from '@angular/material/core';
import { MatTableDataSource } from '@angular/material/table';
import {SelectionModel} from '@angular/cdk/collections';
import { MatPaginator } from '@angular/material/paginator';
import { ExcelService } from 'src/app/services/ucp/UCPSharedControls/Controls/excel.service';
...
@Component({
  selector: 'app-ucp-product-schedule',
  templateUrl: './ucp-product-schedule.component.html',
  styleUrls: ['./ucp-product-schedule.component.css'],
  providers: [DatePipe]
})


export class UcpProductScheduleComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'Fixing', 'Settlement','pS_TSM_Code'];  
  ...
  ngOnInit(): void {
    try{
      console.log("inside product schedule")
             ...
             if (response.status === Status.Success) {
                 ...
                 if (res) {
                    ...
                    if (this.oProdSchedule.length>0)
                    {
                      ...
                      this.oProdSchedule.map(i=>{i.Fixing={ fieldName: i.pS_Id, id:"Fixing", value: moment(i.pS_Fixing_Date).format("DD-MMM-YYYY"), readOnly: "" },i.Settlement= { fieldName: i.pS_Id, id:"Settlement", value: moment(i.pS_Settlement_Date).format("DD-MMM-YYYY"), readOnly: "" }}); //for keeping it in sync with date control // Added by OnkarE
                      this.oProdSchedule.forEach(element => {
