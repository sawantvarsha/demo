...
@Component({
  selector: 'app-wof-and-ko-chart',
  templateUrl: './wof-and-ko-chart.component.html',
  styleUrls: ['./wof-and-ko-chart.component.css']
})
export class KoAndWorstOfPerformanceChartComponent {
  constructor(private service: KoAndWorstOfPerformanceService, private dashboardService: DashboardServiceService,private bIReportsComponent:BIReportsComponent,private koAndWorstOfPerformanceComponent:KoAndWorstOfPerformanceComponent) {
  }
...
display(){
  ...
  pinChart(e: any, title) {
    this.koAndWorstOfPerformanceComponent.pinned()
    e.preventDefault();
    ...
    const chart = {
    data,data1,productlist,worstList, labels, options, backgroundColor,backgroundColor1, borderColor, borderWidth, title,id,current_min_KO,current_max_KO,worstOfUnderlying,client,selectedOption,selectedOption1,bg1,bg2
   }
  ...
  setComponentProperties() {
    ...
    this.data.forEach((data) => {
      ...
      temp_wof_list = [...temp_wof_list, data["WorstOfPerformance"]]
    ...
    this.maxElement=Math.max(maxWof,maxKo)
    ...
    this.chart = new Chart("ko-chart", {
      ...
      data: {
        ...
        },
        {
          ...
          data: this.woflist,
          backgroundColor: Array(this.woflist.length).fill('#6d97bf'),
        }
        ],
      },
      options: {
