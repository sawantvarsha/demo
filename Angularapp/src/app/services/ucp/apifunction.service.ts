...
export class ApifunctionService {
  ...
  getModuleData(UserGroup, UCPMode, LoginID, iEntityId): Promise<any> {
    try {
      return this.http.post(AppConfig.settings.apiBaseUrl + "UCPCTL/"+'GetProductClass', { UserGroup: UserGroup, UCPMode: UCPMode, LoginID:LoginID, iEntityId:iEntityId }, { headers: this.headerOptions }).toPromise();
    } catch (error) {
      console.error(error);
    } finally {
    }
  ...
  getTemplateData(schemeId: any,sControlType:string, UCPMode, UserID, iEntityId, UserGroup): Promise<any> {
    try {
      const body = {
        UCPLogInFavouritesTemplates: '',
        UCPMode,
  ...
  getAllTemplates(usergroup, loginId, entityId, StaticList, Application): Promise<any> { //added by devesh for getting all templates data
    try {
      ...
      return this.http.post(AppConfig.settings.apiBaseUrl + "UCPCTL/"+'GetAllTemplates', body, { headers: this.headerOptions }).toPromise();
    } catch (error) {
      console.error(error);
    } finally {
    }
  ...
  getTemplateMapping(template_Id: any,AppType: string, template_Name: string, UCPMODE, LoginId, sUserGroup): Promise<any> {
    try {
      ...
      console.log("chcekkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk", body.sApplicationType,body.iTemplateID)
  ...
  GetFunctionDetails(template_Id: any): Promise<any> {
    try {
      return this.http.post(AppConfig.settings.apiBaseUrl + "UCPCTL/"+'GetFunctionDetails', { TemplateId: template_Id }, { headers: this.headerOptions }).toPromise();
    } catch (error) {
      console.log(error);
    } finally {
    }
  ...
  GetDealDetails(NoteMasterId, NoteDealId) {
  ...
  GetMappedTabsDetails(sTemplateId, sQueueId, sMode , sUserGroup, User_ID){
    try {
      ...
      return this.http.post(AppConfig.settings.apiBaseUrl + "UCPCTL/"+'GetMappedTabsDetails', body, { headers: this.headerOptions });
    } catch (err) {
    } finally {
    }
  }
 ...
 WriteErrorLogs(message) {
  ...
  GetStaticData(NotMasterId:number){
    try {
      ...
      return this.http.post(AppConfig.settings.apiBaseUrl + "UCPCTL/"+'GetStaticData1', oReq, { headers: this.headerOptions }).toPromise();
    } catch (err) {
    } finally {
    }
  }
...
//Added by RajeshC on 17-Sept || SubscriptionTab
  ...
  GetMutationHistory(iNoteMasterId) {
    try{
      ...
      console.log("GetMutationHistorydata API Service........", oReq);
  ...
  GetMutatingFields(iTemplateId) {
    try{
      ...
      console.log("GetMutatingFields data API Service........", oReq);
