...
export class BasicBarChartComponent implements OnInit {
  ...
  color: any;
  @Input() get colorArray() {
    return this.color;
  }
  set colorArray(colorArray: any) {
  ...
  setChartOptionspnl() {
    ...
    if (this.graphdata.length !== 0) {
      ...
      if (this.chartOptions?.series[1]?.data) {
        this.chartOptions.series[1].data = this.graphdata.map((d: any) => d[2]);
      }
